...
def main(jsonInputForMultiplier, jsonInputFileForVectors, outputFileName):
...
def usage():
    sys.stderr.write("""
    given a multiplier.json and a shopvectors.json goes through ALL the stores and finds the five most similar stores. Third argument should be output file you want to write to like "similarShops.dat" for example you might use: \n
